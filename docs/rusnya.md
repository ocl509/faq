...
Перейти на список: [DNI: 🚨 Терміновий Блок/Карантин!](https://bsky.app/profile/did:plc:bmjomljebcsuxolnygfgqtap/lists/3jyh6vcbrfl2z)
...
[^2]: Апеляції
	...
	Якщо ви в одному із автоматизованих списків (5 та 6): ці списки оцінюють лише ваші взаємодії, отже потрапляння в той чи інший список є прямим наслідком ваших власних дій на конкретному акаунті. В разі гострої необхідності в таких взаємодіях - ви завжди можете створити окремий акаунт для цього. Тому оскільки ваші взаємодії з російським контентом негативно вплинуть на рекомендації контенту для всього Українського кластеру[^3] (а не тільки для вас) - на разі апеляції щодо акаунтів, які вже перебувають в російському чи білоруському кластері (списки 5-6) **НЕ ПРИЙМАЮТЬСЯ**. Дякуємо за розуміння.

	Ви все ще можете звернутись до [@appeal.mobik.zip](https://bsky.app/profile/appeal.mobik.zip) за детальнішою інформацією. Цей акаунт допоможе надати вам інвайт-код для створення нового акаунту та всю необхідну інформацію, стрічки та список порад аби уникнути непорозумінь в майбутньому. Загалом мати окремі акаунти для взаємодії з різним контентом - є хорошою практикою інформаційної гігієни.
